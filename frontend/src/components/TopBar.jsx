        ...
        <div className="border-2 border-black bg-black flex justify-between">
            ...
            <form className="flex items-center">   
                <div className="relative w-full">
                    {/* search-bar */}
                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Search Movies, Series, Tv Shows..." required />
                </div>
